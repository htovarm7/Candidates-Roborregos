...
void loop() {
    Ultrasonico(ultrasonicoFrontalEcho, ultrasonicoFrontalTrig);
    Ultrasonico(ultrasonicoDerechaEcho, ultrasonicoDerechaTrig);
    Ultrasonico(ultrasonicoIzquierdaEcho, ultrasonicoIzquierdaTrig);
